...
<header id="navbar">
    ...
    <section>
        ...
        <form onsubmit="return validate()" name="registration" action="membership.php" method="post">
            <div class="signup">
                ...
                <input id="email" class="form-control" type="email" name="email"  placeholder="E-mail" required><br><br>
                <input id="user" class="form-control" type="text" name="username"  placeholder="User name" required><br><br>
